...
DEFAULT_VOCI_BACKOFFICE = [
    ...
    {"id": "voce-demoliz-muri", "category": "MURATURA", "name": "Demolizione muri", "prezzo_acquisto": 22.0, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-demoliz-pavim", "category": "MURATURA", "name": "Demolizione pavimento", "prezzo_acquisto": 18.0, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-demoliz-rivest", "category": "MURATURA", "name": "Demolizione rivestimento pareti", "prezzo_acquisto": 16.5, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-demoliz-controsoff", "category": "MURATURA", "name": "Demolizione controsoffitto", "prezzo_acquisto": 14.0, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-piastrelle-pav", "category": "MURATURA", "name": "Piastrelle pavimento", "prezzo_acquisto": 28.0, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-piastrelle-riv", "category": "MURATURA", "name": "Piastrelle rivestimento", "prezzo_acquisto": 25.0, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-posa-piastrelle-pav", "category": "MURATURA", "name": "Posa piastrelle pavimento", "prezzo_acquisto": 22.0, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-posa-riv-ceramica", "category": "MURATURA", "name": "Posa rivestimento ceramica", "prezzo_acquisto": 27.5, "ricarico": 1.8, "unit": "m²"},
    {"id": "voce-massetto", "category": "MURATURA", "name": "Massetto autolivellante", "prezzo_acquisto": 22.0, "ricarico": 1.8, "unit": "m²"},
    ...
    # PIASTRELLE / PAVIMENTI SPECIFICI (per scelta TIPO nel CAD - tool Schema piastrelle)
    {"id": "voce-gres-cemento-60x60", "category": "MURATURA", "name": "Gres porcellanato effetto cemento 60×60", "prezzo_acquisto": 22.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-marmo-60x120", "category": "MURATURA", "name": "Gres porcellanato effetto marmo 60×120", "prezzo_acquisto": 38.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-legno-22x90", "category": "MURATURA", "name": "Gres porcellanato effetto legno 22.5×90", "prezzo_acquisto": 28.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-pietra-80x80", "category": "MURATURA", "name": "Gres porcellanato effetto pietra 80×80", "prezzo_acquisto": 32.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-mono-30x60", "category": "MURATURA", "name": "Gres monocolore 30×60 (basic)", "prezzo_acquisto": 14.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-marmo-naturale-25x150", "category": "MURATURA", "name": "Marmo naturale 25×150 (premium)", "prezzo_acquisto": 95.0, "ricarico": 1.7, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-parquet-rovere-pl", "category": "MURATURA", "name": "Parquet rovere prefinito plancia", "prezzo_acquisto": 48.0, "ricarico": 1.8, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-parquet-noce-spina", "category": "MURATURA", "name": "Parquet noce a spina ungherese (premium)", "prezzo_acquisto": 95.0, "ricarico": 1.7, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-pvc-effetto-legno", "category": "MURATURA", "name": "PVC SPC effetto legno (resistente acqua)", "prezzo_acquisto": 22.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-laminato-ac4", "category": "MURATURA", "name": "Laminato AC4 (alta resistenza)", "prezzo_acquisto": 18.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-piast-mosaico-bagno", "category": "MURATURA", "name": "Mosaico vetroso bagno (decorazione)", "prezzo_acquisto": 65.0, "ricarico": 1.7, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-piast-cucina-10x10", "category": "MURATURA", "name": "Piastrella cucina 10×10 (paraschizzi)", "prezzo_acquisto": 28.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-piast-bagno-25x40", "category": "MURATURA", "name": "Rivestimento bagno 25×40 standard", "prezzo_acquisto": 16.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    ...
    {"id": "voce-condiz-mono", "category": "IMPIANTI", "name": "Climatizzatore mono split", "prezzo_acquisto": 750.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-canalizzato", "category": "IMPIANTI", "name": "Climatizzatore canalizzato (controsoffitto)", "prezzo_acquisto": 3200.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-vmc", "category": "IMPIANTI", "name": "Ventilazione meccanica controllata (VMC)", "prezzo_acquisto": 1850.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-pompa-calore", "category": "IMPIANTI", "name": "Pompa di calore aria/acqua", "prezzo_acquisto": 4200.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-scaldabagno", "category": "IMPIANTI", "name": "Scaldabagno (boiler elettrico)", "prezzo_acquisto": 320.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-termoarredo", "category": "IMPIANTI", "name": "Termoarredo bagno", "prezzo_acquisto": 240.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-termosifone", "category": "IMPIANTI", "name": "Termosifone alluminio (5 elementi)", "prezzo_acquisto": 95.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-fotovoltaico", "category": "IMPIANTI", "name": "Pannello fotovoltaico (modulo)", "prezzo_acquisto": 280.0, "ricarico": 1.8, "unit": "pz"},
    {"id": "voce-ue", "category": "IMPIANTI", "name": "Unità esterna climatizzatore (UE)", "prezzo_acquisto": 950.0, "ricarico": 1.8, "unit": "pz"},
