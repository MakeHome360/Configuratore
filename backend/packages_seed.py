...
DEFAULT_VOCI_BACKOFFICE = [
    ...
    {"id": "voce-parquet", "category": "PAVIMENTAZIONE_PARQUET", "name": "Parquet", "prezzo_acquisto": 35.0, "ricarico": 1.8, "unit": "m²", "modificabile_dal_venditore": True},
    ...
    # PIASTRELLE / PAVIMENTI SPECIFICI (categorie dedicate per il backoffice — split richiesto dall'utente)
    {"id": "voce-gres-cemento-60x60", "category": "PAVIMENTAZIONE_GRES", "name": "Gres porcellanato effetto cemento 60×60", "prezzo_acquisto": 22.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-marmo-60x120", "category": "PAVIMENTAZIONE_GRES", "name": "Gres porcellanato effetto marmo 60×120", "prezzo_acquisto": 38.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-legno-22x90", "category": "PAVIMENTAZIONE_GRES", "name": "Gres porcellanato effetto legno 22.5×90", "prezzo_acquisto": 28.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-pietra-80x80", "category": "PAVIMENTAZIONE_GRES", "name": "Gres porcellanato effetto pietra 80×80", "prezzo_acquisto": 32.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-gres-mono-30x60", "category": "PAVIMENTAZIONE_GRES", "name": "Gres monocolore 30×60 (basic)", "prezzo_acquisto": 14.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-marmo-naturale-25x150", "category": "PAVIMENTAZIONE_MARMO", "name": "Marmo naturale 25×150 (premium)", "prezzo_acquisto": 95.0, "ricarico": 1.7, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-parquet-rovere-pl", "category": "PAVIMENTAZIONE_PARQUET", "name": "Parquet rovere prefinito plancia", "prezzo_acquisto": 48.0, "ricarico": 1.8, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-parquet-noce-spina", "category": "PAVIMENTAZIONE_PARQUET", "name": "Parquet noce a spina ungherese (premium)", "prezzo_acquisto": 95.0, "ricarico": 1.7, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-pvc-effetto-legno", "category": "PAVIMENTAZIONE_LAMINATO", "name": "PVC SPC effetto legno (resistente acqua)", "prezzo_acquisto": 22.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-laminato-ac4", "category": "PAVIMENTAZIONE_LAMINATO", "name": "Laminato AC4 (alta resistenza)", "prezzo_acquisto": 18.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-piast-mosaico-bagno", "category": "RIVESTIMENTO_PIASTRELLE", "name": "Mosaico vetroso bagno (decorazione)", "prezzo_acquisto": 65.0, "ricarico": 1.7, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-piast-cucina-10x10", "category": "RIVESTIMENTO_PIASTRELLE", "name": "Piastrella cucina 10×10 (paraschizzi)", "prezzo_acquisto": 28.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
    {"id": "voce-piast-bagno-25x40", "category": "RIVESTIMENTO_PIASTRELLE", "name": "Rivestimento bagno 25×40 standard", "prezzo_acquisto": 16.0, "ricarico": 1.9, "unit": "m²", "modificabile_dal_venditore": True},
