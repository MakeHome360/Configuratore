...
export default function DettaglioCommessa() {
  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            ...
            <Button onClick={() => nav(`/commesse/${c.id}/workflow`)} variant="outline" data-testid="open-workflow-btn" className="border-blue-500 text-blue-700"><FileText className="h-4 w-4 mr-2" />Apri Workflow Cantiere</Button>
      ...
      />
      <Page>
        <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-4 text-sm flex items-center justify-between" data-testid="info-workflow-banner">
          <div className="text-blue-900">
            💡 Questa è la <b>Vista classica</b> con calendario task, rilievo misure, voci acquisti e dati economici. Per il workflow avanzato (Gantt + Computo a 3 viste + Scadenze pagamenti + Checklist + Sub-appaltatori) clicca <b>"Apri Workflow Cantiere"</b> in alto.
          </div>
        </div>
